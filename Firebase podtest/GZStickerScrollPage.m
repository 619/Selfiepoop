...
@protocol VirtualObjectSelectionViewControllerDelegate
- (void)virtualObjectSelectionViewController(self,  didSelectObjectAt index: Int)
- (void)virtualObjectSelectionViewController(self,  didDeselectObjectAt index: Int)
@end

VirtualObjectSelectionViewControllerDelegate *delegate;
